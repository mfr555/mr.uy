        ...
        <div class="row d-flex justify-content-center">
            ...
            <div id="web-starter" class="col-md-4">
                <div class="card text-center shadow-sm">
                    ...
                    <div class="card-body">
                        <h5 class="lead text-muted mb-0">Perfecto comenzar en la web y ser visto en Google</h5>
                        <div class="m-1"></div>

                        <div class="d-flex justify-content-center align-items-baseline m-0">
                            <div class="h5 mb-0">Tu web por solo</div>
                            <div class="m-1"></div>
                            <small class="text-violeta text-sm"><del>U$S 599</del></small>
                        </div>
                        <div class="d-flex justify-content-center align-items-baseline p-1">
                            <h3 class="text-violeta h2 p-0 mt-0 mb-1 w-50 border-bottom rounded">U$S 299</h3>
                        </div>
                        ...
                        <table class="table text-start">
                            <tbody>
                                ...
                                <tr>
                                    <td>U$S 40 / año para mantenerla activa</td>
                ...
                <div class="card text-center shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center align-items-baseline">
                            ...
                            <div class="m-1"></div>
                            <h3 class="my-2 text-naranja h2">U$S 299</h3>
                            <small class="m-3 text-naranja"><del>U$S 599</del></small>
                        </div>

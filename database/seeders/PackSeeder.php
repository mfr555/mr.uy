...
class PackSeeder extends Seeder
{
    ...
    public function run(){
        ...
        $webStarterPack = [
            ...
            'color' => 'violeta',
            'items' => [
                ['name' => 'Página web profesional en 48 hs', 'included' => true],
                ...
                ['name' => 'Google Ads inicial', 'included' => true],
            ...
            'info' => [
                'Perfecto comenzar en la web y ser visto en Google',
            ],
            'more_info' => [
        ...
        $webEstandarPack = [
            ...
            'items' => [
                ...
                ['name' => 'Google Ads inicial con monitoreo bimensual', 'included' => true],
                ['name' => 'Soporte técnico dedicado', 'included' => true],
        ...
        $webCorporativaPack = [
            ...
            'items' => [
                ...
                ['name' => 'Google Ads con monitoreo bimensual', 'included' => true],
                ['name' => 'Soporte técnico dedicado', 'included' => true],
